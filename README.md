...
2. [自定义HUD指示器模板代码，改造AlertDialog，可以禁止用户交互和允许用户交互：ProgressHUD.java](https://github.com/mxmhao/Android_App_Template/blob/master/app/src/main/java/template/ProgressHUD.java)
